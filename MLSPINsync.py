...
def updateLongTerm(dbCollection: pymongo.database.Database, timeDelta: datetime.timedelta) -> None:
...
def updateShortTerm(dbCollection: pymongo.database.Database, timeDelta: datetime.timedelta) -> None:
    """Updates the collection in MongoDB with all the listings modified after oldestTimestamp
